...
describe('Cadastro de Paciente', () => {
    it('Cadastrar um paciente com dados válidos', (done) => {
        ...
        .end((err,res) => {
            ...
            res.body.should.have.property('success').eql('Paciente inserido com sucesso')
            done()
        })
    })
    ...
    it('Cadastrar um paciente com dados obrigatórios em branco', (done) => {
        ...
        .end((err,res) => {
            ...
            res.body.should.have.property('error').eql('Campos obrigatórios em branco,favor conferir')
            done()
        })
    })
...
describe('Update de Paciente', () => {
    it('Alteração de paciente com dados válidos', (done) => {
        ...
        .end((err, res) => {
            res.should.have.status(200)
            res.body.should.have.property('success').eql('Paciente alterado com sucesso')
            done()
        })
    })
